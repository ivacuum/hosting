...
/**
 * Эта миграция намеренно включает в себя все таблицы. Для этого проекта важно лишь конечное состояние базы данных, поэтому новые миграции постепенно консолидируются в эту одну большую.
 *
 * Название осталось от первой миграции. Чтобы она случайно не запустилась еще раз в продакшне, было решено не переименовывать ее.
 *
 * Все окружения этого проекта, кроме продакшна, регулярно сбрасываются в начальное состояние.
 */
