...
use App\Domain\Life\FlagCode;
use App\Domain\Life\Observer\CountryObserver;
use App\Domain\Life\Policy\CountryPolicy;
use App\Traits;
 ...
 * @property \Illuminate\Database\Eloquent\Collection<int, City> $cities
