...
class InstagramApiFake
{
    ...
    {
        return [
            'graph.instagram.com/v23.0/me/media?*' => InstagramCreateMediaResponse::fakeSuccess($id),
        ];
    }
    ...
    {
        return [
            'graph.instagram.com/v23.0/me/media?*' => InstagramCreateMediaResponse::fakeInvalidMedia(),
        ];
    }
    ...
    {
        return [
            'graph.instagram.com/v23.0/me?*' => InstagramMeResponse::fakeSuccess(),
        ];
    }
    ...
    {
        return [
            'graph.instagram.com/v23.0/me/media_publish?*' => InstagramPublishMediaResponse::fakeSuccess($id),
        ];
    }
    ...
    {
        return [
            'graph.instagram.com/v23.0/me/media_publish?*' => \Http::sequence()
    ...
    {
        return [
            'graph.instagram.com/v23.0/refresh_access_token?*' => InstagramRefreshAccessTokenResponse::fakeSuccess($accessToken),
        ];
    }
}
