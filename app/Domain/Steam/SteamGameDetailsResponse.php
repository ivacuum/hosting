...
readonly class SteamGameDetailsResponse
{
    ...
    public static function fakeNotFound(int $appId): PromiseInterface
    {
    ...
    public static function fakeSuccess(int $appId, SteamLanguage $language = SteamLanguage::English): PromiseInterface
    {
        return Factory::response([
            $appId => [
                'success' => true,
