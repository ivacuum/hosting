...
{
    public function execute(string $q, int $categoryId, bool $fulltext): array
    {
    ...
    private function meilisearch(string $q, int $categoryId)
    {
    ...
    private function sphinx(string $q, int $categoryId, bool $fulltext)
    {
