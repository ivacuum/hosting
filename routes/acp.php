...
Route::group(['prefix' => 'domains'], function () {
    ...
    Route::get('{slug}', 'Acp\Domains@show');
    Route::put('{slug}', 'Acp\Domains@update');
    Route::delete('{slug}', 'Acp\Domains@destroy');
    Route::get('{slug}/dkim-secret-key', 'Acp\Domains@dkimSecretKey');
    Route::get('{slug}/edit', 'Acp\Domains@edit');
    Route::get('{slug}/mail', 'Acp\Domains@mailboxes');
    Route::post('{slug}/mail', 'Acp\Domains@addMailbox');
    Route::get('{slug}/ns-records', 'Acp\Domains@nsRecords');
    Route::post('{slug}/ns-records', 'Acp\Domains@addNsRecord');
    Route::put('{slug}/ns-records', 'Acp\Domains@editNsRecord');
    Route::delete('{slug}/ns-records', 'Acp\Domains@deleteNsRecord');
    Route::get('{slug}/ns-servers', 'Acp\Domains@nsServers');
    Route::get('{slug}/robots', 'Acp\Domains@robots');
    Route::post('{slug}/server-ns', 'Acp\Domains@setServerNsRecords');
    Route::get('{slug}/yandex-pdd-status', 'Acp\Domains@yandexPddStatus');
    Route::post('{slug}/yandex-ns', 'Acp\Domains@setYandexNs');
    Route::get('{slug}/whois', 'Acp\Domains@whois');
});
