...
<div class="tw-mt-12 tw-max-w-600px">
  ...
  @en
    <p>Use the form below to ask a question or share your thoughts. We will use your feedback to make the trainer better. There are certainly things to improve. <span class="tw-whitespace-no-wrap">ありがとうございます。</span></p>
  @endru
  <feedback-form
