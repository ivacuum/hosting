...
<div class="mw-600">
  @ru
    ...
    <p class="mt-4"><strong>Как это работает без перехода по ссылке</strong>. Вы заказываете симку за 10&nbsp;евро (доставка включена), затем пополняете баланс на минимальную сумму 25&nbsp;евро. В итоге у вас на счету 25&nbsp;евро.</p>
