...
<div class="mw-600">
  @ru
    ...
    <p class="tw-mt-6"><strong>Как это работает без перехода по ссылке</strong>. Вы заказываете симку за 10&nbsp;евро (доставка включена), затем пополняете баланс на минимальную сумму 25&nbsp;евро. В итоге у вас на счету 25&nbsp;евро.</p>
    ...
    {{--
    <h2 class="tw-mt-12">Промокоды</h2>
    ...
    <h2 class="tw-mt-12">Чем хорош Дримсим?</h2>
