...
<section class="bg-gray-700 py-20 text-gray-300">
  <div class="container lg:max-w-3xl">
    ...
    <div class="grid md:grid-cols-2 gap-x-12 gap-y-8">
      ...
      <div>
        <h5 class="font-medium text-lg mb-1 text-gray-400">Отсутствие рейтинга</h5>
        <div>Рейтинг &mdash; не повод отказывать себе в просмотре интересного материала! Скачивайте любое количество информации!</div>
      </div>
      <div>
        <h5 class="font-medium text-lg mb-1 text-gray-400">Скорость обмена</h5>
      ...
      <div>
        <h5 class="font-medium text-lg mb-1 text-gray-400">Быстродействие</h5>
        <div>Узкие места трекера были оптимизированы для достижения максимального быстродействия и низкого времени отклика.</div>
      </div>
      <div>
        <h5 class="font-medium text-lg mb-1 text-gray-400">Опытная команда</h5>
      ...
      <div>
        <h5 class="font-medium text-lg mb-1 text-gray-400">Поиск</h5>
        <div>Умная система поиска найдет раздачи даже по одному символу! А также предложит подсказки по мере ввода запроса!</div>
      </div>
      <div>
        <h5 class="font-medium text-lg mb-1 text-gray-400">Информеры</h5>
      ...
      {{--
      <div>
        <h5 class="font-medium text-lg mb-1 text-gray-400">Ленты</h5>
        <div>Читайте новости, гороскоп и истории с развлекательных сайтов не выходя с трекера!</div>
      </div>
      --}}
      <div>
        <h5 class="font-medium text-lg mb-1 text-gray-400">Графики</h5>
        <div>Вы можете окунуться в историю развития трекера, посмотрев на рост графиков статистики: скорости обмена, посещаемости, притока пользователей, раздач, сообщений и трафика.</div>
      </div>
    </div>
  </div>
</section>
