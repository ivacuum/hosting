...
<section class="pt-4 pb-12">
  <div class="container lg:max-w-3xl">
    ...
    <h3 class="mt-12">Особенности ретрекера</h3>
    <ul>
    ...
    <h3 class="mt-12">Потребляемые ресурсы</h3>
    ...
    <h3 class="mt-12">Структура проекта</h3>
