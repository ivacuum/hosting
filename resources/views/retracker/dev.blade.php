...
@section('content')
<h3 class="m-t-0">Общие сведения</h3>
<p>Ретрекер написан на языке <a class="link" href="http://www.perl.org/">Perl</a> с использованием следующих модулей:</p>
<ul>
...
<h3 class="m-t-2">Особенности ретрекера</h3>
<ul>
...
<h3 class="m-t-2">Потребляемые ресурсы</h3>
<p>Измерение проводилось после непрерывной работы ретрекера в течение недели. Занимаемый объем оперативной памяти составил <b>5 976 КБ</b> при 1 050 пирах на 1 097 раздачах. К тому моменту было обслужено <b>1 705 680</b> подключений.</p>

<h3 class="m-t-2">Структура проекта</h3>
<p>Проект состоит их 3 файлов:</p>
<ul>
  <li><b>btrt.pl</b> (11 534 байт) — основная логика приложения;</li>
  <li><b>functions.plib</b> (6 046 байт) — вспомогательные функции;</li>
  <li><b>run</b> (1 598 байт) — файл запуска приложения.</li>
</ul>
<p><a class="btn btn-primary" href="{{ action('Files@download', 122) }}">Скачать исходные коды ретрекера</a></p>

<h3 class="m-t-2">Варианты запросов к ретрекеру</h3>
<ul>
  <li><b>http://bt.ivacuum.ru:2790/ann</b> — запрос списка пиров;</li>
  <li><b>http://bt.ivacuum.ru:2790/ping</b> — проверка состояния трекера;</li>
  <li><b>http://bt.ivacuum.ru:2790/stats</b> — просмотр краткой статистики (количества пиров и раздач, о которых знает ретрекер).</li>
</ul>

<h3 class="m-t-2">Хранимые данные пиров</h3>
<ul>
  <li><b>mtime</b> — время последнего обращения к ретрекеру;</li>
  <li><b>seeder</b> — является ли пир сидом.</li>
</ul>

<h3 class="m-t-2">Хранимые данные раздач</h3>
<ul>
