...
@section('content')
<h3 class="mt-0">Общие сведения</h3>
...
<h3 class="mt-4">Особенности ретрекера</h3>
<ul>
...
<h3 class="mt-4">Потребляемые ресурсы</h3>
...
<h3 class="mt-4">Структура проекта</h3>
...
<h3 class="mt-4">Варианты запросов к ретрекеру</h3>
<ul>
