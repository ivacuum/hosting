...
<section class="pt-4 pb-12">
  <div class="container lg:max-w-3xl">
    <h3 class="font-medium text-2xl mb-2">Общие сведения</h3>
    ...
    <h3 class="font-medium text-2xl mb-2 mt-12">Особенности ретрекера</h3>
    <ul>
    ...
    <h3 class="font-medium text-2xl mb-2 mt-12">Потребляемые ресурсы</h3>
    ...
    <h3 class="font-medium text-2xl mb-2 mt-12">Структура проекта</h3>
    <div>Проект состоит из 3 файлов:</div>
    <ul class="mt-1 mb-4">
    ...
    <p><a class="btn btn-primary" href="@lng/files/122/dl">Скачать исходный код ретрекера</a></p>

    <h3 class="font-medium text-2xl mb-2 mt-12">Варианты запросов к ретрекеру</h3>
    <ul>
    ...
    <h3 class="font-medium text-2xl mb-2 mt-12">Хранимые данные пиров</h3>
    <ul>
      <li><b>mtime</b> — время последнего обращения к ретрекеру;</li>
      <li><b>seeder</b> — является ли пир сидом.</li>
    </ul>

    <h3 class="font-medium text-2xl mb-2 mt-12">Хранимые данные раздач</h3>
    <ul>
