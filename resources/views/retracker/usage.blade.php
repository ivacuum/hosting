...
<section class="pt-4 pb-12">
  <div class="container lg:max-w-3xl">
    ...
    <p>
      <span class="inline-flex bg-grey-600 text-white px-2 font-medium rounded-sm mr-1">1</span>
      Выбрать в клиенте раздачу:
    </p>
    @include('tpl.screenshot', ['pic' => 'https://img.ivacuum.ru/g/100710/1_58sS4cweRE.png', 'w' => 438, 'h' => 70])

    <p>
      <span class="inline-flex bg-grey-600 text-white px-2 font-medium rounded-sm mr-1">2</span>
    ...
    <p>
      <span class="inline-flex bg-grey-600 text-white px-2 font-medium rounded-sm mr-1">3</span>
    ...
    <p>
      <span class="inline-flex bg-grey-600 text-white px-2 font-medium rounded-sm mr-1">4</span>
    ...
    <p>
      <span class="inline-flex bg-grey-600 text-white px-2 font-medium rounded-sm mr-1">5</span>
