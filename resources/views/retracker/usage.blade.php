...
<section class="pt-4 pb-12">
  <div class="container lg:max-w-3xl">
    ...
    <p>
      <span class="inline-flex bg-grey-600 text-white px-2 font-medium rounded mr-1">2</span>
    ...
    <p>
      <span class="inline-flex bg-grey-600 text-white px-2 font-medium rounded mr-1">3</span>
    ...
    <p>
      <span class="inline-flex bg-grey-600 text-white px-2 font-medium rounded mr-1">4</span>
    ...
    <p>
      <span class="inline-flex bg-grey-600 text-white px-2 font-medium rounded mr-1">5</span>
