...
<section class="bg-gray-50 dark:bg-slate-800 border-t border-b border-gray-200 dark:border-slate-700 py-12">
  <div class="container lg:max-w-3xl">
...
<section class="py-12">
  <div class="container lg:max-w-3xl">
    ...
    <pre class="mb-4 text-sm bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 p-2 rounded-sm whitespace-pre-wrap">wget https://ivacuum.org/d/rt/retracker.local.sh
...
<section class="bg-gray-50 dark:bg-slate-800 border-t border-gray-200 dark:border-slate-700 py-12">
  <div class="container lg:max-w-3xl">
