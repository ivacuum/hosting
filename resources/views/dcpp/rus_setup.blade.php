...
@ru
  ...
  <ol>
    ...
    <li>
      ...
      <p><img class="max-w-full h-auto" src="https://img.ivacuum.ru/g/091002/1_LEcAuwMxCr.gif" width="661" height="499"></p>
    </li>
    ...
    <li>
      ...
      <p><img class="max-w-full h-auto" src="https://img.ivacuum.ru/g/091002/1_1M7VcFUbBe.gif" width="561" height="415"></p>
    </li>
    <li>Укажите в этом окне файл русификации и нажмите «<strong>Открыть</strong>».</li>
    <li>
      <p>После этого нажмите «<strong>ОК</strong>».</p>
      <p><img class="max-w-full h-auto" src="https://img.ivacuum.ru/g/091002/1_D7OwjJUgBu.gif" width="661" height="499"></p>
    </li>
    ...
    <li>
      ...
      <p><img class="max-w-full h-auto" src="https://img.ivacuum.ru/g/091002/1_06xcHm1YXB.gif" width="661" height="499"></p>
    </li>
  </ol>
@endru
@endsection
