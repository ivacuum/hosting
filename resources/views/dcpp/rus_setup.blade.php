...
@ru
  ...
  <p>
    <a class="btn btn-primary tw-my-1 tw-mr-2" href="{{ path('Files@download', 157) }}">
      Русификатор ApexDC++ &middot; {{ ViewHelper::size(21464) }}
    </a>
    <a class="btn btn-primary tw-my-1" href="{{ path('Files@download', 28) }}">
      Русификатор GreyLinkDC++ &middot; {{ ViewHelper::size(108876) }}
    </a>
  </p>

  <h2 class="tw-mt-12">Как русифицировать клиент</h2>
  <ol>
    <li>Установите и запустите программу.</li>
    <li>
      <p>Если перед вами не откроется окно с настройками, откройте «File — Settings».</p>
      <p><img class="tw-max-w-full tw-h-auto" src="https://img.ivacuum.ru/g/091002/1_LEcAuwMxCr.gif" width="661" height="499"></p>
    </li>
    ...
    <li>
      ...
      <p><img class="tw-max-w-full tw-h-auto" src="https://img.ivacuum.ru/g/091002/1_1M7VcFUbBe.gif" width="561" height="415"></p>
    </li>
    <li>Укажите в этом окне файл русификации и нажмите «<strong>Открыть</strong>».</li>
    <li>
      <p>После этого нажмите «<strong>ОК</strong>».</p>
      <p><img class="tw-max-w-full tw-h-auto" src="https://img.ivacuum.ru/g/091002/1_D7OwjJUgBu.gif" width="661" height="499"></p>
    </li>
    ...
    <li>
      ...
      <p><img class="tw-max-w-full tw-h-auto" src="https://img.ivacuum.ru/g/091002/1_06xcHm1YXB.gif" width="661" height="499"></p>
    </li>
  </ol>
@endru
@endsection
