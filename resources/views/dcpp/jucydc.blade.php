...
<div {{ str_contains($css_classes, ['linux', 'macos']) ? 'hidden' : '' }} class="js-dcpp-client">
...
<div {{ !str_contains($css_classes, ['linux']) ? 'hidden' : '' }} class="js-dcpp-client">
...
<div {{ !str_contains($css_classes, ['macos']) ? 'hidden' : '' }} class="js-dcpp-client">
