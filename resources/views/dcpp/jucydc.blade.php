...
@ru
  ...
  <p>В базовой поставке нет русского языка. Если для вас это критичный фактор, то обратите внимание на другие клиенты на нашем сайте, например, на <a class="link" href="@lng/dc/flylinkdc">FlyLinkDC++</a>.</p>
@en
