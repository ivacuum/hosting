...
<div>
  <a class="btn btn-success btn-lg tw-my-1 tw-mr-2" href="{{ path('Files@download', 154) }}">
    <span class="tw-mr-1">
      @svg (windows)
    </span>
    {{ trans('dcpp.download') }} 32-Bit &middot; {{ ViewHelper::size(23018257) }}
  </a>
  <a class="btn btn-success btn-lg tw-my-1 tw-mr-2" href="{{ path('Files@download', 155) }}">
    <span class="tw-mr-1">
      @svg (windows)
    </span>
