...
<div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
  <label class="col-md-2 control-label required">Электронная почта:</label>
  <div class="col-md-10">
...
<div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
  <label class="col-md-2 control-label required">Пароль:</label>
  <div class="col-md-10">
...
<div class="form-group flush">
  <div class="col-md-10 col-md-offset-2 checkbox">
    ...
    <label>
      <input type="checkbox" name="active" value="1" {{ 1 == old('active', @$user->active) ? 'checked' : '' }}>
      Активен
    </label>
  </div>
</div>
...
<div class="form-group flush">
  <div class="col-md-10 col-md-offset-2 checkbox">
    ...
    <label>
      <input type="checkbox" name="is_admin" value="1" {{ 1 == old('is_admin', @$user->is_admin) ? 'checked' : '' }}>
      Администратор
    </label>
  </div>
</div>
