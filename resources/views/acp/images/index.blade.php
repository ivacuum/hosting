...
<div class="btn-toolbar m-b-1">
  <div class="btn-group">
    <a class="btn btn-default" href="{{ Request::fullUrlWithQuery(['type' => null]) }}">
      @svg (th-list)
    </a>
    <a class="btn btn-default" href="{{ Request::fullUrlWithQuery(['type' => 'columns']) }}">
      @svg (th)
    </a>
  </div>
  <div class="btn-group">
    <a class="btn btn-default" href="{{ Request::fullUrlWithQuery(['year' => null, 'page' => 1]) }}">Все</a>
    <a class="btn btn-default" href="{{ Request::fullUrlWithQuery(['year' => 2016, 'page' => 1]) }}">16</a>
  ...
  <div class="btn-group">
    <a class="btn btn-default" href="{{ Request::fullUrlWithQuery(['touch' => null, 'page' => 1]) }}">Все</a>
