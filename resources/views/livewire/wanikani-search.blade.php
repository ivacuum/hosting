    ...
    <div class="my-4">
      @foreach ($radicals as $radical)
        ...
        >
          ...
          @else
            <div class="text-4xl flex-shrink-0 font-bold leading-none ja-shadow pb-1 whitespace-no-wrap">{{ $radical->character }}</div>
          @endif
      ...
      @foreach ($kanjis as $kanji)
        <a
          ...
          href="{{ $kanji->www() }}"
        >
          <div class="text-4xl flex-shrink-0 font-bold leading-none ja-shadow pb-1 whitespace-no-wrap">{{ $kanji->character }}</div>
      ...
      @foreach ($vocabularies as $vocab)
        <a
          ...
          href="{{ $vocab->www() }}"
        >
          <div class="text-4xl flex-shrink-0 font-bold leading-none ja-shadow pb-1 whitespace-no-wrap">{{ $vocab->character }}</div>
          <div class="flex-grow text-right">
