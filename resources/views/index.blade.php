...
<div class="row justify-content-start">
  @ru
    <div class="col-md-6 col-lg-4 d-none d-md-block tw-mb-6">
      <a class="d-flex tw-items-center tw-mb-2 link-parent" href="{{ path('Torrents@index') }}">
  ...
  <div class="col-md-6 col-lg-4 tw-mb-6">
    <a class="d-flex tw-items-center tw-mb-2 link-parent" href="{{ path('Life@index') }}">
  ...
  @ru
    <div class="col-md-6 col-lg-4 d-md-none tw-mb-6">
      <a class="d-flex tw-items-center tw-mb-2 link-parent" href="{{ path('News@index') }}">
        <h2 class="h3 tw-mb-0"><span class="link">{{ trans('news.index') }}</span></h2>
      </a>
      <div>Хроника развития сайта с 2004 года.</div>
    </div>
    <div class="col-md-6 col-lg-4 tw-mb-6">
      <a class="d-flex tw-items-center tw-mb-2 link-parent" href="https://kupislona.ru/">
    ...
    <div class="col-md-6 col-lg-4 d-none d-md-block tw-mb-6">
      <a class="d-flex tw-items-center tw-mb-2 link-parent" href="{{ path('Gallery@index') }}">
  ...
  @endru
  <div class="col-md-6 col-lg-4 d-none d-md-block tw-mb-6">
    <a class="d-flex tw-items-center tw-mb-2 link-parent" href="{{ path('Dcpp@index') }}">
  ...
  @ru
    <div class="col-md-6 col-lg-4 d-none d-md-block tw-mb-6">
      <a class="d-flex tw-items-center tw-mb-2 link-parent" href="http://t.ivacuum.ru">
    ...
    <div class="col-md-6 col-lg-4 tw-mb-6">
      <a class="d-flex tw-items-center tw-mb-2 link-parent" href="{{ path('ParserVk@index') }}">
  ...
  @endru
  <div class="col-md-6 col-lg-4 tw-mb-6">
    <a class="d-flex tw-items-center tw-mb-2 link-parent" href="{{ path('Coupons@index') }}">
  ...
  <div class="col-md-6 col-lg-4 tw-mb-6">
    <a class="d-flex tw-items-center tw-mb-2 link-parent" href="{{ path('Japanese@index') }}">
...
<div class="d-flex flex-wrap mobile-wide">
  @foreach ($trips as $trip)
    ...
    <div class="flex-basis-100 flex-sm-basis-50 flex-lg-basis-33 tw-mx-auto md:tw-mx-0 position-relative">
