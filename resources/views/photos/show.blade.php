...
<div class="row">
  <div class="col-md-10 mb-3">
    <div class="photo-show-container">
      @if (!is_null($next))
        <a class="photo-show-nav photo-show-prev js-pjax js-pjax-no-dim" id="previous_page" href="{{ action("$self@show", [$next->id, 'city_id' => $city_id, 'country_id' => $country_id, 'tag_id' => $tag_id]) }}">&nbsp;</a>
        <div class="fotorama__arr fotorama__arr--prev no-pointer-events" tabindex="0" role="button"></div>
      @endif
      @if (!is_null($prev))
        <a class="photo-show-nav photo-show-next js-pjax js-pjax-no-dim" id="next_page" href="{{ action("$self@show", [$prev->id, 'city_id' => $city_id, 'country_id' => $country_id, 'tag_id' => $tag_id]) }}">&nbsp;</a>
