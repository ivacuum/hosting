...
@section('content')
<h1 class="font-medium text-4xl tracking-tight mb-2">@lang('Английский')</h1>
@ru
  <p class="mb-12">Конспект информации, освоенной во время изучения языка.</p>
@endru

<a id="irregular-verbs"></a>
<h2 class="font-medium text-3xl tracking-tight mb-2">@ru Неправильные глаголы @en Irregular Verbs @endru</h2>
<?php
$irregularVerbs = [
  ['be', 'was', 'been'],
  ['bear', 'bore', 'born(e)'],
...
<a id="articles"></a>
<h2 class="font-medium text-3xl tracking-tight mb-2">@ru Артикли @en Articles @endru</h2>
<blockquote>
