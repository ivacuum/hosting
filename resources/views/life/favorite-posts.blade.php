...
@section('content')
<h1 class="font-medium text-3xl tracking-tight mb-2">@lang('Любимые посты')</h1>
<p>Сборка ссылок на различные понравившиеся страницы в интернете.</p>

<div class="grid md:grid-cols-2 gap-12">
  <div>
    <h3 class="font-medium text-2xl tracking-tight mb-1">Интересное</h3>
    <ul>
    ...
    <h3 class="font-medium text-2xl tracking-tight mt-12 mb-1">Пополняемое</h3>
    <ul>
  ...
  <div>
    <h3 class="font-medium text-2xl tracking-tight mb-1">Подборки по странам</h3>
    <ul>
    ...
    <h3 class="font-medium text-2xl tracking-tight mt-12 mb-1">Отдельные посты про путешествия</h3>
    <ul>
