...
@ru
  <p>В очереди на концерт дали по кислой таблетке.</p>
@endru

@ru
  <p>Снова на концерте девушки с зафиксированными ногами (гипсом?). Охранник одной передо мной что-то громко говорил, показывая на ногу.</p>
@endru

@ru
  <p>На три мужских туалета на концерте семь женских.</p>
@endru

@ru
  <p>Сильно поливали на танцполе даже до начала концерта — в прошлые годы ни разу такого не заставал. Раньше только пушки по краям работали, но не фонтаны по всему периметру.</p>
@endru

@ru
  <p>Удобно, когда живешь недалеко от места проведения — можно получить по паспорту билет, вернуться домой, скинуть все лишнее и пойти налегке к моменту запуска на танцпол.</p>
@endru

@ru
  <p>Обнимались с корейцами на танцполе, делали кружочек, орали тексты в лицо друг другу, показывали есурия.</p>
@endru

@ru
  <p>В Пусане в пятницу звук баса был слишком громкий и перегруженный, вокал было не очень слышно. В субботу убавили бас — все стало каким-то тихим, будто сильно шуметь в округе было нельзя.</p>
@endru


@component('tpl.setlist', ['cover' => 'https://life.ivacuum.org/gigs/psy.2025.08.15.jpg'])
