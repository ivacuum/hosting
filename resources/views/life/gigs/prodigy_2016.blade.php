...
@section('content')
@ru
  <p>Меньше площадку для выступления международно известной группы еще поискать. Сет подобран на удивление масштабный — выступление преодолело отметку полутора часов. Начался концерт аж только в 21:40. Звук был относительно тихий, прорезавшись на треках Diesel Power и Smack My Bitch Up. Давка в гардеробе по окончании была куда жестче, чем слэм перед сценой.</p>
@endlang
