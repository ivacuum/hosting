...
@section('content')
@ru
  <p>Начнем с предыстории. Впервые про Псая услышал в августе 2012 года во время просмотра ежегодного чемпионата по Доте 2. У песни <a class="link" href="https://www.youtube.com/watch?v=9bZkp7q19f0">Гангнам стайл</a> тогда было «всего» несколько сотен миллионов просмотров, но к декабрю того же года она преодолела рубеж в миллиард, став международным хитом. Тогда еще вычитал, что у Псая в послужном списке было уже шесть альбомов.</p>
@endru
...
@ru
  <p>2018 год. В очередной раз вспомнил про Псая на рубеже лета и осени. И в этот раз меня унесло. Попалась куча концертных видосов, причем поиск на корейском выдавал куда более интересные результаты, в том числе любительские записи с полей. Вместе с этим был изучен официальный твиттер и инстаграм.</p>
@endru
...
@ru
  <p>Понял, что хочу увидеть потрясающую корейскую публику вживую, подписался на твиттер Псая и стал ждать. Забегая вперед, отмечу, что стоило подписываться на инстаграм, так как у него он в разы активнее.</p>
@endru
...
@ru
  <p>Пришлось овладеть навыком скоростного нажатия F5 и моментального выбора ячейки. Эдак с десятой попытки получилось урвать билет в самый ближний к сцене стоячий сектор. <span class="text-nowrap">145&thinsp;000</span> вон — это около <span class="text-nowrap">9&thinsp;000</span> рублей. Так-то конвертер валют вам может показать сумму меньше, но еще ж двойная конвертация валют, которая суммарно съест дополнительные 5–10%.</p>
@endru
  ...
  <div class="col-md-7">
    ...
    <ol start="8">
      ...
      <li>
        ...
        <small class="text-muted">Napal Baji</small>
        <span class="text-danger">@svg (heart)</span>
      </li>
      <li>
        <a class="link" href="https://www.youtube.com/watch?v=5TT4qvedULU">끝</a>
        <small class="text-muted">The End</small>
        <span class="text-danger">@svg (heart)</span>
      </li>
      <li>
      ...
      <li>
        ...
        <small class="text-muted">Shake It</small>
      </li>
      <li>
        <a class="link" href="https://www.youtube.com/watch?v=gxavJwXQc0M">어땠을까 (feat. 헤이즈)</a>
        <small class="text-muted">What Would Have Been</small>
      </li>
    </ol>
    ...
    <ol start="14">
      ...
      <li>
        ...
        <small class="text-muted">Gangnam Style</small>
      </li>
    </ol>
    ...
    <ol start="24">
      ...
      <li>
        ...
        <small class="text-muted">Last Scene</small>
        <span class="text-danger">@svg (heart)</span>
      </li>
    </ol>
...
@ru
  <p>После сетов 1, 2 и 3 были приглашенные местные звезды, которые исполняли 3–4 песни. Где-то в районе четвертого сета Псай сказал волшебную фразу энкор (на бис). Далее мы ее повторяли практически после каждой песни. <a class="link" href="https://youtu.be/vwEn2rh4RUw?t=77">Пример</a>. И он выходил петь и танцевать еще и еще. Даже после тридцатой повторяли — и он снова вышел. Говорил минуту-другую что-то непонятное и совсем ушел.</p>
@endru

@ru
  <p>Сколько же длился концерт? Изначально думал часа в три ночи уже лягу спать. Не тут-то было. Если взять тридцать песен Псая, прибавить десяток песен приглашенных исполнителей, умножить на какие-нибудь средние шесть минут, то уже выходит 40&times;6=240 минут или 4 часа! Оценка близка к действительности, потому что концерт шел с 23:45 до примерно 05:00. Откуда еще лишний час? Все исполнители немало болтали с публикой, особенно Псай. Он не раз вылавливал кого-нибудь взглядом на трибунах или танцполе, просил оператора показать человека на большом экране и вел с ним беседу. Остается загадкой о чем именно он говорил, так как навык понимания корейского на слух у меня отсутствует. Несколько раз он просил весь зал замолчать, а своего собеседника закричать изо всех сил — и кричавшего при этом было отлично слышно где именно в зале он находится. <a class="link" href="https://youtu.be/YlHKylJtvTw?t=441">Пример</a>. Также однажды на экране показывали людей в возрасте, посетивших концерт.</p>
@endru
...
@ru
  <p>В определенный момент стало ясно, что это имена и фамилии присутствующих. У корейцев они суммарно из трех слогов. Последний слайд содержал имена на одной латинице. Буквально несколько десятков имен из <span class="text-nowrap">12&thinsp;500</span> посетителей! <a class="link" href="https://youtu.be/mixE6js4dps?t=242">Видео</a>.</p>
@endru
...
@ru
  <ul>
    <li>Песня It's Art <a class="link" href="https://www.youtube.com/watch?v=1cKc1rkZwf8">в официальном клипе</a> из нарезки выступлений разных лет и <a class="link" href="https://www.youtube.com/watch?v=C3v2z75AizY">вживую</a>.</li>
