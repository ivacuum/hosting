...
@ru
  <p>Сегодня зеленый билет со входным номером 300. По опыту предыдущих концертов, было логичным встать в очередь с номерами 241–360. В самый ее конец. Так и было сделано, но ребята рядом говорили, мол, вы не на своем месте стоите. При этом объяснить куда правильно следует встать они не смогли.</p>
@endru
...
@component('tpl.setlist', ['cover' => 'https://life.ivacuum.org/gigs/psy.2019.12.20.jpg'])
  ...
  <ol class="list-inside pl-0" start="19">
    ...
    <li>Sigh</li>
    <li><a class="link" href="https://www.youtube.com/watch?v=aIkXxFt8_dw">에술이야</a> <span class="text-sm text-gray-500">It's Art</span></li>
  </ol>
  ...
  <ol class="list-inside pl-0" start="38">
    <li>챔피언 <span class="text-sm text-gray-500">Champion</span></li>
    <li><a class="link" href="https://www.youtube.com/watch?v=SuAwlBDyBc0">연예인</a> <span class="text-sm text-gray-500">Entertainer</span></li>
    <li>강남스타일 <span class="text-sm text-gray-500">Gangnam Style</span></li>
