...
<div class="row">
  <div class="col-md-7">
    @ru
      ...
      <p>Новый тур группы Rammstein. Это будет уже семнадцатое выступление по счету в России и шестое в СПб. Сетлист будет известен вместе с первым концертом в Гельзенкирхене 27 мая. Незадолго до этого (весной) будет выпущен новый студийный альбом, название которого пока остается неизвестным.</p>
