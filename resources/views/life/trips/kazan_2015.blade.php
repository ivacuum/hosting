...
@ru
  <p>Четыре дня и три ночи оказались идеальной продолжительностью для поездки. В <a class="link" href="kaliningrad.2015">Калининграде</a> было три дня: в первый прилетели, а на третий уже улетели. Провести два полных дня в городе гораздо лучше, то есть, например, прилететь в пятницу, а улететь обратно в понедельник. Конечно, не для любого места подойдет такая схема, но в этот раз она сработала на отлично.</p>
@endru
