...
<p>Балконы лепят самые разные.</p>
@include('tpl.fotorama', ['pics' => [
  'IMG_0162.jpg',
  'IMG_0164.jpg',
  'IMG_0191.jpg',
...
<p>Здесь хотя бы у опоры не такое ужасное расположение.</p>
...
<p>Газ зачем-то пускают по воздуху. В <a class="link" href="/life/yakutsk">Якутске</a> так делают из-за вечной мерзлоты, здесь причина неочевидна.</p>
...
<p>Кондиционеры на домах выглядят как бородавки. Ужасное зрелище.</p>
