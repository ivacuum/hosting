...
@ru
  <p>День независимости Беларуси, оказывается, на дворе.</p>
@endlang
...
@ru
  <p>3 часа ожидания дали понять, что Брест нужно обходить стороной. Куда лучше проходить границу Гродно—Белосток. Всегда можно <a class="link" href="http://gpk.gov.by">свериться с сайтом</a>, чтобы узнать обстановку на пограничных пунктах на текущий момент.</p>
  <p>Небяспека — опасность.</p>
@endlang
