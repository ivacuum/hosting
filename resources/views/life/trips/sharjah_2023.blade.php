...
@section('content')
@ru
  <p>Авиарейс из Белграда задержался, поэтому шансы успеть на метро, а затем на автобус до жилья растворялись с каждой минутой.</p>
@endru
@include('tpl.pic-2x', ['pic' => 'IMG_1926.jpg'])

@ru
  <p>Паспортный контроль. Роскошь страны чувствуется уже в аэропорту.</p>
@endru
...
@ru
  <p>Лента выдачи багажа. Еще в аэропорту можно получить бесплатную сим-карту со связью на сутки.</p>
@endru
@include('tpl.pic-2x', ['pic' => 'IMG_1929.jpg'])

@ru
  <p>Довез до жилья в итоге таксист за наличные евро, потому что местные деньги не наменял в аэропорту. А стоило наменять — так поездка вышла бы на треть дешевле.</p>
@endru
...
@ru
  <p>33 этажа в отеле Шератон.</p>
@endru
@include('tpl.pic-2x', ['pic' => 'IMG_1931.jpg'])

@ru
  <p>Номер на ближайшую неделю. Именно здесь стало ясно, что при полной рабочей занятости и вне отпуска совсем некомфортно не иметь дальнейших планов. То есть, в свободное от трудовой деятельности время нужно выбирать куда полететь и где жить. Если брать жилье на неделю, то либо каждые выходные будет стресс выбора нового места, либо выходные будут тратиться на переезд. Цены на перелеты в последний момент тоже не всегда привлекательные. В итоге, номер был продлен еще на неделю — на onlinetours.ru можно взять за рубли отдельно только проживание в отеле без полного тура с перелетом и страховкой.</p>
@endru
...
@ru
  <p>Контейнер для ненужных вещей.</p>
@endru
...
@ru
  <p>На вокзале тоже транспортной карты не нашлось. Пришлось покупать в отеле дирхамы, чтобы без переплат доехать на такси до аэропорта и изучить каким бы был путь до жилья в Шардже в дневное время. Что интересно, официальный курс дирхама жестко привязан к доллару США — уже двадцать лет за 1 доллар США дают 3,67 дирхамов ОАЭ.</p>
@endru
...
@ru
  <p>Первый терминал аэропорта на красной ветке метро. До второго терминала пока на метро не доехать.</p>
@endru
...
@ru
  <p>Эскалаторы в начале и конце платформы ходят в разные стороны. Если ошибиться, то предстоит путь по длинной лестнице.</p>
@endru
...
@ru
  <p>В Эмиратах свой разъем электрической розетки. Еще в отеле выведены другие распространенные компьютерные и ТВ-порты, снабженные иконками.</p>
@endru
...
@ru
  <p>Круглосуточный супермаркет Спиннис, в котором товары со всего света.</p>
@endru
@include('tpl.fotorama-2x', ['pics' => [
  'IMG_1983.jpg',
  'IMG_1961.jpg',
...
@ru
  <p>Рупоры на вышке, через которые пять раз в день голосят молитвы. Прямо с шести утра. И далее примерно каждые три часа. Не спасают даже закрытые окна отеля.</p>
@endru
@include('tpl.fotorama-2x', ['pics' => [
  'IMG_2105.jpg',
  'IMG_2111.jpg',
...
@ru
  <p>Мечеть короля Фейсала.</p>
@endru
@include('tpl.pic-2x', ['pic' => 'IMG_2214.jpg'])

@ru
  <p>Сбор ненужной одежды.</p>
@endru
...
@ru
  <p>Фасад жилого дома песочного цвета.</p>
@endru
...
@ru
  <p>Чайник — точка продажи чая навынос.</p>
@endru
...
@ru
  <p>Результат проекции на мечети.</p>
@endru
@include('tpl.fotorama-2x', ['pics' => [
  'IMG_2247.jpg',
  'IMG_2252.jpg',
...
@ru
  <p>Пылесос для борьбы с мусором на улице.</p>
@endru
...
@ru
  <p>В лифте санитайзер для рук.</p>
@endru
...
@ru
  <p>2ГИС подсказал прямой автобус в аэропорт, о котором не знал Гугл. До последнего не верилось, что автобус придет. Маршрут 313 с вокзала Шарджи с остановками по городу и до терминала 2 аэропорта Дубая.</p>
@endru
@include('tpl.pic-2x', ['pic' => 'IMG_2268.jpg'])

@ru
  <p>У входа во второй терминал.</p>
@endru
