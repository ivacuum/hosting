...
@section('content')
@ru
  <p>Что было известно о Дании заранее? Что она в Скандинавии, что в ней большое велосипедное движение.</p>
@endlang

@ru
  <p>Что стало известно по ходу планирования поездки? Что стоимость аренды комнаты в 2–3 раза выше, чем в Берлине. Это сразу насторожило, так как весь тур изначально обещал быть очень бюджетным, но в Копенгагене все резко поменялось.</p>
@endlang
...
@ru
  <p>Отличный способ понять как много услуг включено в стоимость авиабилета, когда пробуешь лететь без них. Например, не было даже автобуса до самолета — шли пешком из терминала по аэродрому. Если вам как-то удалось пронести большую сумку до самолета, то на подходе к нему ее могут отжать в платный багаж — бортпроводники со специальной тележкой для транспортировки в полной боевой готовности.</p>
@endlang
