...
@ru
  <p>Добротный тротуар вдоль дороги. Знак сообщает, что закончился район Канк.</p>
@endlang
...
@ru
  <p>Овцы. При виде меня ближняя аж попрыгнула от неожиданности и стала убегать.</p>
@endlang
...
@ru
  <p>Лавочка перед огорожденной скульптурой.</p>
@endlang
