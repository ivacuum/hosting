...
@ru
  <p>Крайне выгодно пользоваться общественным транспортом с <a class="link" href="http://troika.mos.ru/">картой Тройка</a>. Также в центре постоянно попадается <a class="link" href="https://velobike.ru/">велопрокат</a>, к которому можно привязать Тройку для удобства оплаты.</p>
