...
@ru
  <p>Отлично выбрал день приезда в день митингов. Тверская временно перекрыта. Обходить более получаса.</p>
@endru
...
@ru
  <p>Между первым и вторым этажом козырек, защищающий от всего падающего.</p>
@endru
...
@ru
  <p>А в таких потемках даже не стал бы пробовать снимать. Но сегодня успех. Хм, стоит посетить всю <a class="link" href="cities">сотню увиденных городов</a>, чтобы поснимать их в темное время суток?</p>
@endru
...
@ru
  <p>Закат на набережной во время пробы городского велопроката.</p>
@endru
@include('tpl.fotorama-2x', ['pics' => [
  'IMG_0056.jpg',
  'IMG_0057.jpg',
...
@ru
  <p>Лифты в метро пока еще редкость.</p>
@endru
...
@ru
  <p>В туалет в метро можно попасть по транспортной карте Тройка. Само существование туалета уже удивляет.</p>
@endru
