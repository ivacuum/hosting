...
@ru
  <p>Здесь можно ненадолго почувствовать себя миллионером. Всего за 4&thinsp;000 ₽.</p>
@endru

@ru
  <p>Обменный курс 1 к 250 быстро учит встречаемые цены делить на 1&thinsp;000 и умножать на 4. Какой большой купюрой не решишь расплатиться, так все равно получишь еще больше бумажек сдачи. Минимальная купюра 100 рублей, монет нет — будут после деноминации.</p>
@endru
...
@ru
  <p>Хорошо, что в это время проходил крупнейший в СНГ киберспортивный турнир <a class="link" href="https://starladder.com/">Старладдер</a>. Всего за 4 года ребята достигли впечатляющего уровня развития: многотысячная Минск-арена, трансляция чемпионата в реальном времени, комментирование на 3 языках, сотни тысяч зрителей в интернете. Для сравнения — в этом зале в 2015 году выступала группа Линкин Парк.</p>
@endru
@include('tpl.fotorama-2x', ['pics' => [
  'IMG_2273.jpg',
  'IMG_2272.jpg',
...
@ru
  <p>Ўсё.</p>
@en
  <p>Ўсё ("that's all" in Belarusian).</p>
@endru
@endsection
