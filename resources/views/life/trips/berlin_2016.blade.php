...
<p>Единственное грязное покрытие, после которого понадобилось протирать обувь. За все время пребывания в стране! Это после прохождения контроля на концерт <a class="link" href="/life/rammstein.2016.07">Раммштайна</a>. Пускали только по именным билетам, сверяли с удостоверяющими личность документами. Такая практика оказалась распространена в Германии. На мой взгляд, это неплохой отпор перекупщикам. В России действуют иначе — билеты в продажу поступают порциями вплоть до даты концерта.</p>
@include('tpl.fotorama', ['pics' => [
  'IMG_0736.jpg',
  'IMG_0738.jpg',
  'IMG_0739.jpg',
...
<p>В этом кинотеатре многое показывают на английском. Может место просто такое в деловом районе.</p>
@include('tpl.pic-2x', ['pic' => 'IMG_0757.jpg'])

<p>Судя по почтовым ящикам, где-то здесь офисы Сони и Фэйсбука.</p>
