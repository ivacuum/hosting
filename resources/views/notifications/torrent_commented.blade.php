...
<a class="link" href="{{ path('Torrents@show', $notification->data['id']) }}#comment-{{ $notification->data['comment']['id'] }}">{{ Illuminate\Support\Str::limit($notification->data['title'], 100) }}</a>
