...
<a class="link" href="{{ path([App\Http\Controllers\NewsController::class, 'show'], $notification->data['id']) }}#comment-{{ $notification->data['comment']['id'] }}">{{ Str::limit($notification->data['title'], 100) }}</a>
<time
  class="text-muted"
