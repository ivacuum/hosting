<div class="d-flex flex-wrap flex-sm-nowrap mobile-wide {{ $class ?? '' }}">
  <a
    class="btn bg-telegram f20 flex-grow-1 tw-py-1 rounded-0 text-white w-50 w-sm-auto"
  ...
  <a
    class="btn bg-vk f20 flex-grow-1 tw-py-1 rounded-0 text-white w-50 w-sm-auto"
  ...
  <a
    class="btn bg-facebook f20 flex-grow-1 tw-py-1 rounded-0 text-white w-50 w-sm-auto"
  ...
  <a
    class="btn bg-twitter f20 flex-grow-1 tw-py-1 rounded-0 text-white w-50 w-sm-auto"
  ...
  {{--
  <a
    class="btn bg-google f20 flex-grow-1 tw-py-1 rounded-0 text-white w-50 w-sm-auto"
  ...
  --}}
  <a
    class="btn bg-odnoklassniki f20 flex-grow-1 tw-py-1 rounded-0 text-white w-50 w-sm-auto"
  ...
  @if ($is_mobile)
    <a
      class="btn bg-whatsapp f20 flex-grow-1 tw-py-1 rounded-0 text-white w-50 w-sm-auto"
    ...
    <a
      class="btn bg-viber f20 flex-grow-1 tw-py-1 rounded-0 text-white w-50 w-sm-auto"
