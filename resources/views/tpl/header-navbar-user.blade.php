<details class="self-center relative details-reset details-overlay text-grey-600 hover:text-grey-900 dark:hover:text-slate-200">
  ...
  <details-menu
    role="menu"
    class="absolute top-full right-0 z-50 py-2 bg-white dark:bg-slate-800 mt-1 border border-gray-300 dark:border-slate-700 rounded-sm shadow-md min-w-[10rem]"
  >
