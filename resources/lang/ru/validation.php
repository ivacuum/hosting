...
return [
    ...
    'concurrency_control' => 'Кто-то обновил объект до сохранения ваших правок. Обновите страницу и повторите попытку.', // Вы можете: 1) отменить свои правки — обновить страницу или перейти на другую 2) объединить изменения — в соседней вкладке воспроизвести свои правки 3) перезаписать чужие правки — повторно сохранить изменения.
